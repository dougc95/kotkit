...
export function DemoBanner() {
  ...
  return (
    <aside
      ...
      className="sticky top-0 z-50 border-b border-rule bg-paper px-4 py-2 text-center text-sm text-ink md:flex md:h-10 md:items-center md:justify-center md:py-0"
    >
